...
**`cover_letter.paragraphs`:** 4–5 paragraphs:
  ...
  4. Working language / location / work authorization — she's based in Oulu, Finland, and has worked fully in English throughout her career there; mention willingness to relocate within Finland or work remotely across the EU if relevant to this posting. **Always state explicitly, in every cover letter regardless of role or company, that she holds a valid residence permit to work in Finland, so no visa sponsorship is required, and that she has already applied for a permanent residence permit in Finland.** Also **always mention that she has started learning Finnish, with a view to the future** — phrase it as a forward-looking commitment (e.g. "I have also begun learning Finnish, with a view to continuing to build my life and career here long-term"), never as a claim of current fluency or conversational ability. Both of these are hard requirements, not optional context — do not omit either even if the paragraph otherwise reads fine without them.
