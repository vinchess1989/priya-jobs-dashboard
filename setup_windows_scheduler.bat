...
schtasks /create /tn "%TASK_NAME%" /tr "\"%PYTHON_EXE%\" \"%SCRIPT_PATH%\"" /sc daily /st %SCHEDULE_TIME% /f
...
echo.
echo The task "%TASK_NAME%" has been scheduled to run once a day at %SCHEDULE_TIME%.
